...
public class AlternateBoard {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Each player starts with $500, if you manage to spend all your money before reaching the finish you lose");
        System.out.println(
                "The game is 2 player. The goal is to get from Start to Finish with the most money possible.\nThere are 15 numbered blocks (1-15), plus Start (0) and Finish.");
        System.out.println(
                "Certain blocks are marked as \"SPEND\"(3,7,11,13). When the player lands on one of these blocks, one of the following may happen:");
    ...
    static void reset_game() {
        ...
        // go_ahead() function for the first time, it will increment the total_moves
        // value by 1.
        total_moves = -1;
    }
    ...
    static void surprise_win() {
        System.out.println("Congratulations! You've reached the finish line! YOU SPENT " + mspent + "in " + total_moves
    ...
    public static void MoneyTracker(int value, boolean isMoneySpent) {
        ...
        // if current block is normal block, go to next move
            ...
            // we are calling go_ahead from a normal bloack,hence we will pass second
            // argument as false.
